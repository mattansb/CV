...
My teaching and instructing are focused on undergraduate- and graduate-level statistics, research methods, and R programming. Taught over `r scales::comma(sum(n_students), 10)` students across over a dozen different courses.
