...
- Developer and maintainer of [effectsize](https://cran.r-project.org/package=effectsize) for 
...
:::aside
List of additional packages I've contributed to: [`afex`](https://cran.r-project.org/package=afex), [`ggeffects`](https://cran.r-project.org/package=ggeffects), [`semTools`](https://cran.r-project.org/package=semTools), [`insight`](https://cran.r-project.org/package=insight), [`correlation`](https://cran.r-project.org/package=correlation),  [`parameters`](https://cran.r-project.org/package=parameters), [`modelbased`](https://cran.r-project.org/package=modelbased), [`report`](https://easystats.github.io/report/), [`see`](https://cran.r-project.org/package=see).
:::
...
- Einzinger, T., **Ben-Shachar, M.S.**, Shmueli, M., Auerbach, J.G., Zilberman-Hayun, Y., Atzba-Poria, N., & Berger A. (*in preparation*). "My Brain Can't Stop": an ERP Study of Longitudinal Prediction of Inhibitory Control in Adolecnese.  
