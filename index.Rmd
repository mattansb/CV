...
DOI_link <- function(doi, sci_hub = TRUE){
  host <- if (sci_hub) "sci-hub.ee" else "doi.org"
...
I'm a freelance data analyst and  statistical consultant in service of the social sciences. I recently completed my PhD in neurocognitive psychology (pending approval) at Ben-Gurion University of the Negev, where I researched individual differences in processing speed using electroencephalography (EEG) - a high temporal functional brain imaging technique.

I am also an active R developer and statistical educator, and am very opinionated about data analysis, inferential statistics and reproducible research. I have provided support and consultation in these areas to numerous researchers.
...
Provide freelance consultation and data analysis services for the social scientists. I am deeply rooted in theory and methodology as both an instructor and a **`R`** developer, while also mindful of the practical needs of researchers and academics. I specialize in the following methods:
...
As part of my own research I have lead and managed research projects, including teams of graduate students and research assistants, and collaborated with various international research groups. I provide guidance throughout all stages of the research process and decision-guided statistical analyses.
...
Teaching and instructing has been focused on bachelor- and graduate-level statistics, research methods and R programming. See [*Teaching Experience*](#teaching) section.
...
:::aside
List of additional packages I've contributed to: [`afex`](https://cran.r-project.org/package=afex), [`brms`](https://cran.r-project.org/package=brms), [`ggeffects`](https://cran.r-project.org/package=ggeffects), [`semTools`](https://cran.r-project.org/package=semTools).
:::


### Neurophosiological Signal Processing
<!-- talk about this as signal processing and big data -->
...
Designing experiments and analyzing electroencephalography (EEG) data of event-related brain dynamics using `eeglab`.
...
Developer and reviewer of the MITAM exam (entrance test for advanced degrees in psychology - equivalent to the GRE).
