...
n_courses <- dplyr::n_distinct(count_students$קורס)
...
<center>
<img src="headshots/segel-zutar/square.jpg" style="width:100%; border-radius: 50%;"/>
</center>
...
**Programming:** R, Python, SQL, Stan, Matlab, Git(Hub) (See my [github profile](https://github.com/mattansb)).  

**Documentation:** Quatro/(R)Markdown, Office Suites, Google Docs/Sheets.  
...
My teaching and instructing are focused on undergraduate- and graduate-level statistics, research methods, and R programming.
Over the last `r scales::comma(years_teaching)` years I have taught over `r scales::comma(n_students["1"], 50)` undergraduate students
and over `r scales::comma(n_students["2"], 50)` graduate students across over `r dozen_courses_txt` dozen courses.
...
:::aside
List of additional packages I have contributed to: 
[`afex`](https://cran.r-project.org/package=afex),
...
- Advanced Research Methods for Psychologists (since 2026)  
- [Machine Learning for Psychologists](https://github.com/mattansb/Machine-Learning-foR-Psychologists) (since 2022)  
- Essential Data Science Skills (since 2022)  
- [Hierarchical Linear Models](https://github.com/mattansb/Hierarchical-Linear-Models-foR-Psychologists) (since 2022)  
- Structural equation modelling (2026)
  
Under-graduate level courses:  
- Regression and Multi-Variables Analysis (2022--2023)  
- Experimental Psychology (2018)


#### School of Statistics<!-- and Data Analysis -->, Ben-Gurion University of the Negev


Under-graduate level courses:  
- Bayesian Statistics and Modeling (since 2023)  
- Guided Research (since 2026)  
- Introduction to Data Science (2023--2025)  


#### School of Psychological Sciences, Tel-Aviv University

Graduate level courses:  
- [Data Science Lab for Psychologists](https://github.com/mattansb/Machine-Learning-foR-Psychologists) (since 2023)  
- [Hierarchical Models](https://github.com/mattansb/Hierarchical-Linear-Models-foR-Psychologists) (since 2023)  


#### Sagol School of Neuroscience, Tel-Aviv University

Graduate level courses:  
- Intro to Statistics for Neuroscience (since 2026)


#### School of Cognitive Sciences, Ben-Gurion University of the Negev

Under-graduate level courses:  
- Inferential Statistics for Cognitive Sciences (2022)  
...
Graduate level courses:  
- [Practical applications in R](https://github.com/mattansb/Practical-Applications-in-R-for-Psychologists) (2019--2021)  
- [Structural equation modelling in R](https://github.com/mattansb/Structural-Equation-Modeling-foR-Psychologists) (2020--2021)  
- [Analysis of factorial designs in R](https://github.com/mattansb/Analysis-of-Factorial-Designs-foR-Psychologists) (2019)  

Under-graduate level courses:  
- Experimental Psychology (Fall + Summer 2017)  
- Inferential Statistics (2017--2018)  
- Introduction to Statistics (2015)  


#### Department of Health Systems Management

Graduate level courses:  
- Research Seminar (*for Graduate Students*) (2016--2017)  
...
Selected Publications {data-icon=file #pubs}
--------------------------------------------------------------------------------

:::aside
_h-index: `r scholar::get_profile("Vrbic5QAAAAJ")$h_index`_

For a full list of publications, see my [ORCID](https://orcid.org/0000-0002-4287-4801) or [Google Scholar](https://scholar.google.co.il/citations?user=Vrbic5QAAAAJ) profiles. Contact me a PDF of any of my publications.
...
- Lüdecke, D., Makowski, A.C., Klein, J., **Ben-Shachar, M.S.**, & Makowski, D. (2026). Choosing informative priors in Bayesian regression models: a simulation study and tutorial using Stan and R. *Frontiers in Psychology, 17*, 1856582. `r DOI_link("10.3389/fpsyg.2026.1856582", FALSE)`  
- Hochman, S.\*, **Ben-Shachar, M.S.**\*, Kadosh, R.C., & Henik, A. (2026). A novel task for measuring numerical bias among adults. _Cognition, 271_, 106439. `r DOI_link("10.1016/j.cognition.2026.106439", FALSE)`  
