...
DOI_link <- function(doi, sci_hub = TRUE){
  txt <- paste0("DOI:",doi)
  if (isTRUE(sci_hub)) {
    link <- paste0("http://sci-hub.tw/",doi)
  } else {
    link <- paste0("http://doi.org/",doi)
  }
...
:::aside
List of additional packages I've contributed to: `afex`, `parameters`, `see`, `report`.
:::
...
- *Advanced Research Methods* graduate courses:  
...
- **Ben-Shachar, M. S.**\*, Lisson, S.\*, Shotts-Peretz, D., Hannula-Sormunen, M., & Berger, A. (*in preparation*). Spontaneous Focusing on Numerosity Linked to Quantity Discrimination in Children and Adults.
- Hochman, S., Cohen, Z. Z., **Ben-Shachar, M. S.**, & Henik, A. (*submitted*). Tactile Enumeration and Embodied Numerosity among the Deaf.
- Berger, A., Shmueli, M., Lisson, S., **Ben-Shachar, M. S.**, Lindinger, N. M., Lewis, C. E., Dodge, N. C., Molteno, C. D., Meintjes, E. M., Jacobson, J. L., & Jacobson, S. W. (*submitted*). Deficits in arithmetic error detection in infants with prenatal alcohol exposure: an ERP study.
...
- Makowski, D., **Ben-Shachar M. S.**, Ludecke, D., & Chen, S. A. (*in preparation*). Indices of Effect Existence and Significance in the Bayesian Framework.
<!-- - Pereg, M., ... **Ben-Shachar, M. S.**, ..., & Meiran, N. (*in preparation*). Learning an Abstract General Task Structure in a Rapidly Changing Task Context. -->
