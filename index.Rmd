...
DOI_link <- function(doi, sci_hub = TRUE){
  host <- if (sci_hub) "sci-hub.st" else "doi.org"
...
:::aside
List of additional packages I've contributed to: [`afex`](https://cran.r-project.org/package=afex), [`ggeffects`](https://cran.r-project.org/package=ggeffects), [`semTools`](https://cran.r-project.org/package=semTools).
:::
...
- [*Evaluating Evidence and Making Decisions using Bayesian Statistics*](https://mattansb.github.io/bayesian-evidence-iscop-2021). Workshop at the The 8th Conference on Cognitive Research of the Israeli Society for Cognitive Psychology, Israel.  
...
- Graduate level courses:  
  - [Practical applications in R](https://github.com/mattansb/Advanced-Research-Methods-foR-Psychologists) (Fall 2020; Fall 2019)  
  - [Structural equation modelling in R](https://github.com/mattansb/Structural-Equation-Modeling-foR-Psychologists) (Spring 2021; Spring 2020)  
  - [Analysis of factorial designs in R](https://github.com/mattansb/Analysis-of-Factorial-Designs-foR-Psychologists) (Spring 2020; Spring 2019)  
...
- **Ben-Shachar, M.S.** & Berger, A. (*submitted*). Adaptation to Temporal Predictability is Related to Intelligence.  
...
- Pereg, M., Harpaz, D., Sabah, K., Dreisbach, G., **Ben-Shachar, M.S.**, & Meiran. N. (*submitted*). Learning an abstract general task structure in a rapidly changing task content.  
