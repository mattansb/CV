...
**Programming:** R, Python, Matlab, E-Prime (See my [github profile](https://github.com/mattansb)).  
**Documentation:** Office Suites, (R)Markdown, Google Docs/Sheets.  
...
I am an active R developer and stats and methods educator, and am very opinionated about data analysis, inferential statistics and reproducible research. I have provided support and consolation in these areas to numerous researchers and institutions.
...
### Research Management and Data Analysis
...
As part of [my research](#topics) I have lead and managed research projects, including teams of research assistants and graduate students, and collaborated with various international research groups. I have provided guidance throughout all stages of the research process and decision-guided statistical analyses.

I have also provided consultation and data analysis services for the social sciences, primarily in R; I am deeply rooted in theory and methodology, while also mindful of the practical needs of researchers and academics. I specialize in the following methods:

::: concise
- Generalized linear models (regression, AN(C)OVA)  
- Hierarchical linear mixed effects models (HLM, LMM)   
...
- Core developer of the [*easystats* eco-system of packages](https://easystats.github.io/easystats/) - a collection of R packages, which aims to provide a unifying and consistent framework to tame, discipline and harness the scary R statistics and their pesky models (e.g., [*insight*](https://cran.r-project.org/package=insight), [*parameters*](https://cran.r-project.org/package=parameters), [*performance*](https://cran.r-project.org/package=performance), [*correlation*](https://cran.r-project.org/package=correlation), [*modelbased*](https://cran.r-project.org/package=modelbased), [*report*](https://easystats.github.io/report/), [*see*](https://cran.r-project.org/package=see)).
...
- Graduate level courses:  
  - Hierarchical linear models (Spring 2022\*)  
  - Machine learning for psychologists (Spring 2022\*)  
  - Essential data science skills (Spring 2022\*)  
...
- Shmueli, M., **Ben-Shachar, M.S.**, Jacobson, S.W., Meintjes, E.M., Molteno, C.D., Jacobson, J.L., Berger, A. (*submitted*). Magnitude comparison and automaticity in number processing in adolescents with prenatal alcohol exposure: An event-related potentials study.  
...
- **Ben-Shachar, M.S.** & Berger, A. (*in preparation*). Adaptation to Temporal Predictability is Related to Intelligence.  
- Pinus, M., **Ben-Shachar, M.S.**, Vardimon, O.E., Kessler, Y., & Shachar, G. (*in preparation*). Circular Visual Analog Scale for Self-Criticism.
