...
<i class="fa fa-rss"></i> [Blog](https://shouldbewriting.netlify.com/)  
...
:::aside
List of additional packages I've contributed to: `afex`, `parameters`, `estimate`, `effectsize`, `see`, `report`.
:::
...
- Berger, A., Shmueli, M., Lisson, S., **Ben-Shachar, M.S.**, Lindinger, N.M., Lewis, C.E., Dodge, N. C., Molteno, C.D., Meintjes, E.M., Jacobson, J.L., & Jacobson, S.W. (*accepted*). Deficits in arithmetic error detection in infants with prenatal alcohol exposure: an ERP study. *Developmental Cognitive Neuroscience*.
...
- **Ben-Shachar, M.S.**, Shmueli M., Meintjes, E.M., Molteno, C.D., Jacobson, J.L., Jacobson, S.W., & Berger A. (*submitted*). Prenatal alcohol exposure alters error detection during simple arithmetic processing: An EEG study.
...
- Makowski, D., **Ben-Shachar, M.S.**, Chen, S.A., & Lüdecke, D. (*submitted*). Indices of Effect Existence and Significance in the Bayesian Framework. `r DOI_link("10.31234/osf.io/2zexr", sci_hub = FALSE)`
