...
:::aside
List of additional packages I've contributed to: [`afex`](https://cran.r-project.org/package=afex), [`ggeffects`](https://cran.r-project.org/package=ggeffects), [`semTools`](https://cran.r-project.org/package=semTools), [`insight`](https://cran.r-project.org/package=insight), [`parameters`](https://cran.r-project.org/package=parameters), [`performance`](https://cran.r-project.org/package=performance), [`correlation`](https://cran.r-project.org/package=correlation),  [`modelbased`](https://cran.r-project.org/package=modelbased), [`report`](https://easystats.github.io/report/), [`see`](https://cran.r-project.org/package=see).
:::
...
- **Ben-Shachar, M.S.**, Lüdecke, D., & Makowski, D. (*in preparation*). Size does matter: Estimation and Interpretation of Effect Size Indices and Standardized Parameters.
