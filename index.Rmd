...
:::aside
List of additional packages I've contributed to: [`afex`](https://cran.r-project.org/package=afex), [`ggeffects`](https://cran.r-project.org/package=ggeffects), [`semTools`](https://cran.r-project.org/package=semTools), [`correlation`](https://cran.r-project.org/package=correlation),  [`parameters`](https://cran.r-project.org/package=parameters), [`modelbased`](https://cran.r-project.org/package=modelbased), [`report`](https://easystats.github.io/report/), [`see`](https://cran.r-project.org/package=see).
:::
